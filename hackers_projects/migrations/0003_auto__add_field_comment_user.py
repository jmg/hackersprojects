...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hackers_projects_comment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hackers_projects.Profile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.user'
        db.delete_column('hackers_projects_comment', 'user_id')
